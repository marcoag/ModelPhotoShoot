...
GZ_REGISTER_SYSTEM_PLUGIN(ModelPhotoShoot)
...
/////////////////////////////////////////////
void ModelPhotoShoot::Load(int _argc, char **_argv)
{
  // Turn off sensors.
...
void ModelPhotoShoot::Update()
{
  ...
  if (!this->scene)
  {
    ...
    this->camera->CreateRenderTexture("ModelPhotoShoot_RttTex");
